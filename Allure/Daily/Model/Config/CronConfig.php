...
namespace Allure\Daily\Model\Config;

class CronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/sales_report/schedule/cron_expr';

    const CRON_MODEL_PATH = 'crontab/default/jobs/sales_report/run/model';
