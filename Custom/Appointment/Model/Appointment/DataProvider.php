...
namespace Custom\Appointment\Model\Appointment;

use Custom\Appointment\Model\ResourceModel\Appointment\CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
    ...
    public function getData() {
        ...
        $data = $this->dataPersistor->get('appointment_form_data');
        if (!empty($data)) {
